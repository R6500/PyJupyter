...
History:
  ...
  21/09/2018 : Added method stripTo 
   4/10/2018 : Added Stefan-Boltzmann constant
'''
...
class uVar:
    ...
    # Strip units after converting to unit -----------------------------------

    def stripTo(self,un):
        object = self.copy()
        object = object.convert(un)
        return object.value
...
u_Torr =(133.23*u_Pa).makeUnit('Torr',True) # Torr

u_Bar = (100000*u_Pa).makeUnit('Bar',True) # Bar
...
c_sb = 5.670373e-8 * u_W/(u_m**2 * u_K**4)
